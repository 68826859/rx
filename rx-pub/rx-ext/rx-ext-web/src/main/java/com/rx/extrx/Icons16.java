...
public enum Icons16{
	...
	private String getServletContext(){
		if(ContextLoader.getCurrentWebApplicationContext() != null && ContextLoader.getCurrentWebApplicationContext().getServletContext() != null){
			return ContextLoader.getCurrentWebApplicationContext().getServletContext().getContextPath()+"/resources/images/icons16/";
		}
		return "resources/images/icons16/";
	} 
	...
	File f = new File("D:\\Workspaces\\MyEclipse 10\\rx\\rx-extc\\src\\main\\webapp\\resources\\images\\icon16");
		
	for(File ff: f.listFiles()){
			String name = ff.getName();
			String nm = name.substring(0, name.indexOf(".png"));
