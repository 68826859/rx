...
/**
 * 新增商户主体(PayWechatAccount)
 *
 * @author klf
 * @since 2020-01-09 20:08:50
 */
@ExtClass(extend = ActionForm.class, alternateClassName = "PayWechatAccountAddVo")
public class PayWechatAccountAddVo {

	@ExtFormAction
	SpringAction submitAction = new SpringAction(PayWechatAccountController.class, "addPayWechatAccount");
