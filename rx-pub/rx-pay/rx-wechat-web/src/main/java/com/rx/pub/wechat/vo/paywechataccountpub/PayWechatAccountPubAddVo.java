...
/**
 * 新增支付信息(PayWechatAccountPub)
 *
 * @author klf
 * @since 2020-01-09 20:09:04
 */
@ExtClass(extend = ActionForm.class, alternateClassName = "PayWechatAccountPubAddVo")
public class PayWechatAccountPubAddVo {

	@ExtFormAction
	SpringAction submitAction = new SpringAction(PayWechatAccountPubController.class, "addPayWechatAccountPub");
