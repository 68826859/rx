...
/**
 * 修改微信用户信息(PayWechatUser)
 *
 * @author klf
 * @since 2020-01-09 20:09:45
 */    
@ExtClass(extend = ActionForm.class, alternateClassName = "PayWechatUserUpdateVo")
public class PayWechatUserUpdateVo{
    
    @ExtFormAction
    SpringAction submitAction = new SpringAction(PayWechatUserController.class,"updatePayWechatUser");
