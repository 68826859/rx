 ...
 */    
@ExtClass(extend=ActionForm.class,alternateClassName="PubUserGroupUpdateVo")
public class PubUserGroupUpdateVo{
    
    @ExtFormAction
    SpringAction submitAction = new SpringAction(PubUserGroupController.class,"updatePubUserGroup");
    
  
	@NotBlank(message = "用户组关系不能为空")
    @ExtFormField(label = "用户组关系", allowBlank = false, comp = Hidden.class)
