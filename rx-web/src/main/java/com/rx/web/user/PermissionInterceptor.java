...
public class PermissionInterceptor{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if (handler instanceof HandlerMethod) {
            ...
            Map<Class<? extends RxUser>,StringBuffer> map = null;
            Class<? extends RxUser> ucls = null;
    ...
    private void addMapUserPermission(Map<Class<? extends RxUser>,StringBuffer> map, Class<? extends RxUser> userType,String permissions) {
